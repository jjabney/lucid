...
namespace MyLucid
{
		...
		public class MainLayout : UICollectionViewFlowLayout
		{
			public const float ITEM_HEIGHT = 300.0f;
			public const float ITEM_WIDTH= 500.0f;
			public const int ACTIVE_DISTANCE = 200;
			public const float ZOOM_FACTOR = 0.0f;
			
			public MainLayout ()
			{
				ItemSize = new SizeF (ITEM_WIDTH, ITEM_HEIGHT);
				ScrollDirection = UICollectionViewScrollDirection.Vertical;
				SectionInset = new UIEdgeInsets (20, 10.0f, 20, 10.0f);
